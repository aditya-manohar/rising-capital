// components/CEOSection.tsx - Updated with scroll functionality
'use client'
import { useTheme } from '../context/ThemeContext'
import { motion } from 'framer-motion'
import { Award, Building2, Target, Users, TrendingUp, MapPin, ChevronRight, FileText } from 'lucide-react'
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative z-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                        ...
                        >
                            ...
                            {/* Contact/CTA Card - UPDATED BUTTONS */}
                            <div className={`rounded-2xl border ${currentStyle.border} p-8 transition-colors duration-300 ${theme === 'light'
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    {/* UPDATED: Schedule Consultation button opens modal */}
                                    <button
